...
<head>
    <meta charset="UTF-8">
    <title>Área da Coordenação</title>
...
<body>
    ...
    <p>
        ...
        <a href="registrar.php" class="btn btn-primary">Registrar Solicitação</a>
        <br><br>
        
        <a href="leitura.php" class="btn btn-primary">Verificar Todas Solicitações</a>
        <br><br>
